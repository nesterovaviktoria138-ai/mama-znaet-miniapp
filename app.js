...
const developmentArticles = {
    ...
    1: {
        ...
        communication: `
            ...
            на его звуки. Такое простое общение помогает развитию
    ...
    2: {
        ...
        games: `
            ✓ выкладывай на живот во время бодрствования
            под наблюдением;<br><br>
            ✓ показывай безопасные игрушки;<br><br>
            ✓ разговаривай лицом к лицу;<br><br>
            ✓ используй погремушки и негромкие звуки;<br><br>
            ✓ давай возможность свободно двигать руками и ногами.
        `,

        important: `
            Не нужно специально учить малыша сидеть или ставить
            его на ножки. Сейчас важнее свободное движение
            и игры на безопасной поверхности.
        `
    },
    ...
    3: {
        ...
        intro: `
            Малыш всё активнее изучает своё тело и окружающее
            пространство. Игрушки, лица и собственные руки
        ...
        skills: `
            ...
            • может смеяться и активно улыбаться;<br><br>
            • у некоторых детей появляются попытки переворота.
        `,
        ...
        games: `
            ...
            ✓ продолжай выкладывание на живот во время бодрствования.
        `,
